...
import com.bcsd.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    @Override
    @DataScope(deptAlias = "d")
    public List<TreeSelect> selectCityTreeList(SysDept dept) {
        List<SysDept> depts = deptMapper.selectCityList(dept);
    ...
    @Override
    public List<SysDept> selectDeptIdByDeptName(String deptName) {
        return deptMapper.selectDeptIdByDeptName(deptName);
    }

    @Override
    public List<SysDept> selectDeptSubset() {
        return deptMapper.selectDeptSubset();
    }
