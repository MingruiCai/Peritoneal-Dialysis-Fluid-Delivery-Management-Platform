...
public class SysDeptController extends BaseController {
     ...
     * 获取对应角色部门树列表
     */
    @PostMapping(value = "/city/tree/{type}")
    public AjaxResult deptCityTree(@PathVariable Integer type) {
        return success(deptService.selectCityTreeList(new SysDept(type)));
    }
}
